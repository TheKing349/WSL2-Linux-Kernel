...
There are not a lot of changes needed, just an updated Makefile. The `Microsoft/config-wsl` serves as a Makefile, in which I modified a few lines (check out this [commit](https://github.com/TheKing349/WSL2-Linux-Kernel/commit/3048577284646b9e1e5423e231e89660fa39e830) to learn more).
